...
Магический метод __toString() возвращает результат метода get_html(). Обеспечивает гибкость использования объекта - когда мы просто пытаемся вывести объект в виде строки, он автоматически выводит HTML-код пагинации. (возвращает объект в виде строки)
*/
